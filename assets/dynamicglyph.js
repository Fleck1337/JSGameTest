Game.DynamicGlyph = function(properties) {
	...
	for (var i = 0; i < mixins.length; i++) {
		// Copy over all properties from each mixin as long as it's not the name or init property.
...
Game.DynamicGlyph.prototype.describeA = function(capitalize) {
	...
	// If word starts with a vowel, use an, else use a. Note this is not perfect!
