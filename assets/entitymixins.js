...
Game.EntityMixins.Sight = {
	...
	canSee: function(entity) {
		// If not on the same map or on different floors, then exit entirely
		...
		// If we're not in a square field of view, then we won't be in a real field of view either.
...
Game.EntityMixins.FoodConsumer = {
	...
	getHungerState: function() {
		...
		// 25% of max fullness or less = Hungry.
			...
			return 'Hungry';
		// 95% of max fullness or higher = Oversatiated.
		} else if (this._fullness >= perPercent * 95) {
			return 'Oversatiated';
		// 75% of max fullness or less = Full.
